			...
			<div class="me-3">
				...
				<div class="d-md-none">
					...
					<div class="d-flex flex-wrap align-items-center	text-dark mb-2">
						<div class="text-nowrap	border-end border-light	pe-3 me-3"><i class="fi-dashboard fs-lg	opacity-70 me-2"></i><span class="align-middle">{{ $boat->length }}</span></div>
					...
					<div class="d-none d-md-block	pt-5">
						...
						<div class="d-flex align-items-center text-dark	pb-4 mb-2">
							@if (isset($boat->boatInfo) && !empty($boat->boatInfo) && isset($boat->boatInfo->fuel_capacity))
								<div class="text-nowrap border-end border-light pe-3 me-3"><i class="fi-dashboard	fs-lg opacity-70 me-2"></i><span class="align-middle">{{ $boat->boatInfo->fuel_capacity	?? '' }} gal</span></div>
							@endif
							@if (isset($boat->state))
								<div class="text-nowrap"><i class="fi-map-pin	fs-lg opacity-70 me-2"></i><span class="align-middle">{{ $boat->state ?? '' }} {{ $boat->zip_code ?? '' }}</span></div>
							@endif
