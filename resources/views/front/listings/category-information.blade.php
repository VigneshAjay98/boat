...
@section('content')
    ...
    <div class="container mt-5 py-5">
        ...
        <nav class="mb-3 pt-md-3" aria-label="Breadcrumb">
            <ol class="breadcrumb breadcrumb-dark">
                ...
                <li class="breadcrumb-item"><a href="{{ url('explore/categories') }}">Categories</a></li>
                <li class="breadcrumb-item active" aria-current="page">{{ $category->name ?? $category->uuid ?? '' }}</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="container ">
        <div class="d-sm-flex align-items-end align-items-md-center	justify-content-between	position-relative mb-4"	style="z-index:	1025;">
            <div class="">
                <h1	class="h2 text-dark	mb-md-0"> About {{ $category->name }}</h1>
            </div>
        </div>
        ...
        <!-- Related posts (Carousel)-->
            ...
            <h3 class="h6 mb-3"><a class="nav-link-dark text-capitalize" href="{{ url('explore/yachts/?category='.$category->name) }}">View more >></a></h3>
        @endif
    </div>
@endsection
