        ...
        <div class="col-lg-9">
            ...
            <nav class="mb-3 pt-md-2 pt-lg-4" aria-label="Breadcrumb">
                <ol class="breadcrumb breadcrumb-dark">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Search Yachts</li>
                </ol>
            </nav>
            <!-- Page title-->
            <div class="d-flex align-items-center justify-content-between pb-4 mb-2">
                <h1 class="text-dark me-3 mb-0">Search Yacht</h1>
            ...
            <div class="d-sm-flex align-items-center justify-content-between pb-4 mb-2">
                ...
                @php
                    ...
                    $newPath =  str_replace("/grid", "",$currentUrl);
                @endphp
                <div class="d-none d-sm-flex">
                    <a class="nav-link nav-link-dark px-2" href="{{$newPath}}" data-bs-toggle="tooltip" title="List view"><i class="fi-list"></i></a>
                    <a class="nav-link nav-link-dark px-2 active" href="{{ url('explore/yachts') }}" data-bs-toggle="tooltip" title="Grid view"><i class="fi-grid"></i></a>
                </div>
            </div>
                        ...
                        <div class="col-sm-6 mb-4">
                            <div class="card card-dark card-hover h-100">
                                <div class="tns-carousel-wrapper card-img-top card-img-hover">
                                    ...
                                    @auth
                                        <div class="yacht-grid-list-options" style="">
                                            ...
                                            @else
                                                <form action="{{ url('block-yacht') }}"  method="POST">
                                                    <div class="content-overlay end-0 top-0 pt-3 pe-3">
                                                        @csrf
                                                        <input type="hidden" name="boat_slug" value={{ $boat->slug }}>
                                                        <button class="btn btn-icon btn-light btn-xs text-primary rounded-circle block-boat-button block-boat" data-slug="{{ $boat->slug }}" type="submit" data-bs-toggle="tooltip" data-bs-placement="left" title="Block this yacht"><i class="fi-eye-off"></i></button>
                                                    </div>
                                                </form>
